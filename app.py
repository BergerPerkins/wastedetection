...
def predictRoute():
    try:
        ...
        os.system("cd yolov5/ && python detect.py --weights best_1.pt --img 416 --conf 0.5 --source ../data/inputImage.jpg")
...
def predictLive():
    try:
        os.system("cd yolov5/ && python detect.py --weights best_1.pt --img 416 --conf 0.5 --source 0")
        os.system("rm -rf yolov5/runs")
